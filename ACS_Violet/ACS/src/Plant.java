...
public class Plant extends ClockDomain{
      ...
      case 1 : 
        switch(S2181){
          case 0 : 
            ...
            int biggest2278 = 0;
            if(ends[3]>=biggest2278){
              biggest2278=ends[3];
            }
            if(ends[4]>=biggest2278){
              biggest2278=ends[4];
            }
            if(biggest2278 == 1){
              active[2]=1;
          ...
          case 1 : 
            ...
            int biggest2281 = 0;
            if(ends[3]>=biggest2281){
              biggest2281=ends[3];
            }
            if(ends[4]>=biggest2281){
              biggest2281=ends[4];
            }
            if(biggest2281 == 1){
              active[2]=1;
  ...
  public void thread2270(int [] tdone, int [] ends){
    ...
    int biggest2273 = 0;
    if(ends[6]>=biggest2273){
      biggest2273=ends[6];
    }
    if(ends[7]>=biggest2273){
      biggest2273=ends[7];
    }
    if(biggest2273 == 1){
      active[5]=1;
  ...
  public void thread2266(int [] tdone, int [] ends){
    ...
    int biggest2269 = 0;
    if(ends[3]>=biggest2269){
      biggest2269=ends[3];
    }
    if(ends[4]>=biggest2269){
      biggest2269=ends[4];
    }
    if(biggest2269 == 1){
      active[2]=1;
    ...
    RUN: while(true){
      switch(S2264){
        ...
        case 1 : 
          ...
          int biggest2274 = 0;
          if(ends[2]>=biggest2274){
            biggest2274=ends[2];
          }
          if(ends[5]>=biggest2274){
            biggest2274=ends[5];
          }
          if(biggest2274 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest2286 = 0;
          if(ends[2]>=biggest2286){
            biggest2286=ends[2];
          }
          if(ends[5]>=biggest2286){
            biggest2286=ends[5];
          }
          if(biggest2286 == 1){
            active[1]=1;
